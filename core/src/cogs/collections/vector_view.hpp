...
public:
	...
	template <typename T2, std::enable_if_t<is_array_view_v<T2> && (extent_v<T2> == n) && std::is_convertible_v<remove_extent_t<T2>*, T*> >...>
	this_t& operator=(T2& t)
	{
		decltype(auto) t2(load(t));
		m_contents.m_base = (unsigned char*)static_cast<T*>((T2*)t2.m_contents.m_base;
	...
	// swap
	template <typename T2, std::enable_if_t<!std::is_volatile_v<T2> && is_array_view_v<T2> && (extent_v<T2> == n) && std::is_convertible_v<remove_extent_t<T2>*, T*> && std::is_convertible_v<T*, remove_extent_t<T2>*> >...>
	...
	// exchange
	template <typename T2, std::enable_if_t<is_array_view_v<T2> && (extent_v<T2> == n) && std::is_convertible_v<remove_extent_t<T2>*, T*> && std::is_convertible_v<T*, remove_extent_t<T2>*> >...>
	...
	template <typename T2, typename T3, std::enable_if_t<is_array_view_v<T2> && is_array_view_v<T3> && (extent_v<T2> == n) && (extent_v<T3> == n) && std::is_convertible_v<remove_extent_t<T2>*, T*> && std::is_convertible_v<T*, remove_extent_t<T3>*> >...>
