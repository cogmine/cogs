...
COGS_DEFINE_VOLATILE_ARITHMETIC_DEFAULT_BINARY_ASSIGN_OPERATORS(gcd)
COGS_DEFINE_VOLATILE_ARITHMETIC_DEFAULT_BINARY_ASSIGN_OPERATORS(lcm)
COGS_DEFINE_VOLATILE_ARITHMETIC_DEFAULT_BINARY_ASSIGN_OPERATORS(greater)
COGS_DEFINE_VOLATILE_ARITHMETIC_DEFAULT_BINARY_ASSIGN_OPERATORS(lesser)
