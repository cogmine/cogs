...
template <size_t bits, ulongest poly, bool is_input_reflected, bool is_output_reflected, bits_to_uint_t<bits> initial_value, bits_to_uint_t<bits> xor_out>
...
private:
	...
	static crc_t reflect(const crc_t& c)
	{
		crc_t result = 0;
		crc_t j = 1;
		for (crc_t i = (crc_t)1 << (width_bits - 1); i; i >>= 1)
		{
			if (c & i)
				result |= j;
			j <<= 1;
...
public:
	...
	virtual crc_t get_hash_int() const { return get_crc(); }
...
// Building up the constant from smaller literals appears to work.
static constexpr __int128 crc82_darc_poly1 = 0x0111011401440411;
static constexpr __int128 crc82_darc_poly2 = 0x000000000000308c;
static constexpr __int128 crc82_darc_poly3 = crc82_darc_poly2 << 64;
static constexpr __int128 crc82_darc_poly4 = crc82_darc_poly1 | crc82_darc_poly3;
// static constexpr __int128 crc82_darc_poly5 = 0x308c0111011401440411;
// static_assert(crc82_darc_poly4 == crc82_darc_poly5);

typedef crc<82, crc82_darc_poly4, true, true, 0, 0> crc82_darc;
#endif
