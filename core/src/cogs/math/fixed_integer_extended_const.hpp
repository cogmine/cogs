...
public:
	typedef typename fixed_integer_extended_const<is_const_negative, bits, highDigits...>::template calculate_reduced<low_digit>::type reduced_t;
...
private:
	...
	{
	public:
		typedef typename fixed_integer_extended_const<is_const_negative, bits, highDigits...>::template calculate_reduced<low_digit, lowPart...>::type type;
	};
	...
	template <typename abs_t1, typename abs_t2, bool unused = true>
	...
	template <typename abs_t1, bool unused>
	class get_divide_whole<abs_t1, fixed_integer_extended_const<false, 1, 1>, unused>
	{
	public:
		typedef abs_t1 type;
	};

	template <typename abs_t2, bool unused>
	class get_divide_whole<fixed_integer_extended_const<false, 1, 1>, abs_t2, unused>
	{
	public:
		typedef zero_t type;
	};
	...
	class get_divide_whole<fixed_integer_extended_const<false, 1, 1>, fixed_integer_extended_const<false, 1, 1>, unused>
	{
	public:
		typedef one_t type;
	};
	...
	template <typename T2, bool unused = true>
	class get_modulo
	{
	public:
	...
	template <bool unused>
	class get_modulo<fixed_integer_extended_const<false, 1, 1>, unused>
	{
	public:
	...
	public:
		...
		typedef typename greater_t::template get_modulo<typename lesser_t3::as_extended_t>::type::as_extended_t modulo_t;
	...
	public:
		...
		typedef typename fixed_integer_extended_const<has_sign, (sizeof(ulongest) * 8) + bits, 0, low_digit, highDigits...>::
	...
	template <bool unused, ulongest... highDigits2>
	class bit_scan_forward_extended;

	template <bool unused, ulongest low_digit2>
	class bit_scan_forward_extended<unused, low_digit2>
	{
	public:
		static constexpr bool is_zero = false;
		static constexpr size_t value = fixed_integer_native_const<false, (sizeof(ulongest) * 8), low_digit2>::bit_scan_forward();
	};

	template <bool unused>
	class bit_scan_forward_extended<unused, 0>
	{
	public:
	...
	template <bool unused, ulongest low_digit2, ulongest... highDigits2>
	class bit_scan_forward_extended<unused, low_digit2, highDigits2...>
	{
	public:
		static constexpr size_t value = bit_scan_forward_extended<unused, low_digit2>::is_zero
			? ((sizeof(ulongest) * 8) + bit_scan_forward_extended<unused, highDigits2...>::value)
			: bit_scan_forward_extended<unused, low_digit2>::value;
	};
	...
	template <bool unused, ulongest low_digit2>
	class bit_scan_reverse_extended<unused, low_digit2>
	{
	public:
		static constexpr bool is_zero = false;
		static constexpr size_t value = fixed_integer_native_const<false, (sizeof(ulongest) * 8), low_digit2>::bit_scan_reverse();
	};

	template <bool unused>
	class bit_scan_reverse_extended<unused, 0>
	{
	public:
		static constexpr bool is_zero = true;
		static constexpr size_t value = 0;
	...
	template <bool unused, ulongest low_digit2, ulongest... highDigits2>
	class bit_scan_reverse_extended<unused, low_digit2, highDigits2...>
	{
	public:
		static constexpr bool is_zero = !low_digit2 && bit_scan_reverse_extended<unused, highDigits2...>::is_zero;

		static constexpr size_t value = bit_scan_reverse_extended<unused, highDigits2...>::is_zero
			? bit_scan_reverse_extended<unused, low_digit2>::value
			: (bit_scan_reverse_extended<unused, highDigits2...>::value + (sizeof(ulongest) * 8));
	};
...
public:
	...
	reduced_t simplify_type() const volatile { return reduced_t(); }

	constexpr ulongest get_digit(size_t i) const volatile
	{
		if (i == 0)
			return low_digit;
		if (i >= n_digits)
			return 0;
		fixed_integer_extended_const<has_sign, bits - (sizeof(ulongest) * 8), highDigits...> tmp;
		return tmp.get_digit(i - 1);
	}
	...
	static constexpr bool is_const_exponent_of_two =
		!low_digit
			? fixed_integer_extended_const<is_const_negative, bits, highDigits...>::is_const_exponent_of_two
			: (is_const_negative
				? (((-(longest)low_digit_in & ((longest)~(ulongest)-(longest)low_digit_in + 1)) == low_digit_in)
					&& fixed_integer_extended_const<has_sign_in, bits_in, highDigits...>::is_negative_one)
				: (((low_digit_in & (~low_digit_in + 1)) == low_digit_in)
					&& fixed_integer_extended_const<has_sign_in, bits_in, highDigits...>::is_const_zero)
			);
	...
	constexpr size_t bit_scan_forward() const volatile
	{
		static_assert(!is_const_zero);
		return bit_scan_forward_extended<true, low_digit, highDigits...>::value;
		//return const_bit_scan_forward;
	}

	constexpr size_t bit_scan_reverse() const volatile
	{
		static_assert(!is_const_zero);
		return bit_scan_reverse_extended<true, low_digit, highDigits...>::value;
		//return const_bit_scan_reverse;
	}
	...
	auto operator*(const fixed_integer_native_const<has_sign2, bits2, value2>&) const volatile
	{
		...
		typedef typename abs_t::as_extended_t::template get_multiplied<abs_t2::int_value>::type::reduced_t tmp_t;
	...
	auto operator*(const fixed_integer_extended_const<has_sign2, bits2, values2...>&) const volatile
	{
		...
		typedef typename abs_t::template get_multiplied_extended2<abs_t2>::type::reduced_t tmp_t;
	...
	auto operator%(const fixed_integer_native_const<has_sign2, bits2, value2>&) const volatile
	{
		typename get_modulo<typename fixed_integer_native_const<has_sign2, bits2, value2>::as_extended_t>::type::reduced_t tmp;
		return tmp;
	}
	...
	template <bool has_sign2, size_t bits2, ulongest... values2>
	auto operator/(const fixed_integer_extended_const<has_sign2, bits2, values2...>&) const volatile
	{ return fraction<reduced_t, fixed_integer_extended_const<has_sign2, bits2, values2...> >(); }
	...
	{
		return fraction<fixed_integer_native_const<has_sign2, bits2, value2>, reduced_t>();
	}
	...
	{
		return fraction<fixed_integer_extended_const<has_sign2, bits2, values2...>, reduced_t>();
	}
	...
	template <typename int_t2, typename = std::enable_if_t<is_integral_v<int_t2> > >
	auto inverse_divide(const int_t2& i) const volatile { return fraction<int_t2, reduced_t>(i, *this); }
	template <typename int_t2, typename = std::enable_if_t<is_integral_v<int_t2> > >
	auto inverse_divide(const volatile int_t2& i) const volatile { return fraction<int_t2, reduced_t>(i, *this); }
	...
	{
		typename get_divide_whole2<fixed_integer_extended_const<has_sign2, bits2, values2...> >::type::reduced_t tmp;
		return tmp;
	}
	...
	{
		typedef typename fixed_integer_extended_const<has_sign2, bits2, values2...>::abs_t::as_extended_t abs_t2;
		typename get_gcd2<typename abs_t::as_extended_t, abs_t2>::type::reduced_t tmp;
		return tmp;
	}
	...
	auto lcm(const fixed_integer_extended_const<has_sign2, bits2, values2...>&) const volatile
	{
		...
		typename get_divide_whole<typename mul_t::as_extended_t, typename gcd_t::as_extended_t>::type::reduced_t tmp;
		return tmp;
	}
	...
	auto greater(const fixed_integer_extended_const<has_sign2, bits2, values2...>&) const volatile
	{
		...
		typedef std::conditional_t<b, reduced_t, typename fixed_integer_extended_const<has_sign2, bits2, values2...>::reduced_t> result_t;
		result_t result;
		return result;
	}
	...
	template <bool has_sign2, size_t bits2, ulongest... values2>
	constexpr auto const_compare(const fixed_integer_extended_const<has_sign2, bits2, values2...>&) const volatile
	{
	...
	template <bool has_sign2, size_t bits2, ulongest... values2>
	constexpr auto const_compare(const volatile fixed_integer_extended_const<has_sign2, bits2, values2...>&) const volatile
	{
		constexpr int value = compare_extended2<fixed_integer_extended_const<has_sign2, bits2, values2...> >::value;
		std::conditional_t<value == 0,
			zero_t,
	...
	bool test_bit(size_t i) const volatile
	{
		if (i >= bits)
			return false;
		if (i >= sizeof(ulongest) * 8)
			return fixed_integer_extended_const<false, bits - (sizeof(ulongest) * 8), highDigits...>::test_bit(i - (sizeof(ulongest) * 8));
		return (low_digit & ((ulongest)((ulongest)1 << i))) != 0;
	}

	template <size_t i>
	constexpr bool test_bit_const() const volatile
	{
		if constexpr (i >= bits)
			return false;
		else if constexpr (i >= sizeof(ulongest) * 8)
		{
			constexpr size_t n = i - (sizeof(ulongest) * 8);
			constexpr size_t bits2 = (bits - (sizeof(ulongest) * 8));
			return fixed_integer_extended_const<false, bits2, highDigits...>::template test_bit_const<n>();
		}
		else
			return (low_digit & ((ulongest)((ulongest)1 << i))) != 0;
	}
	...
	auto operator>>(const fixed_integer_native_const<has_sign2, bits2, value2>&) const volatile
	{
		...
		typename right_shift_extended<(is_const_negative2 ? ((size_t)-value2) : (size_t)value2)>::type::reduced_t tmp;
		return tmp;
	}
	...
	{
		static constexpr bool is_const_negative2 = fixed_integer_native_const<has_sign2, bits2, value2>::is_const_negative;
		typename left_shift_extended<true, (is_const_negative2 ? ((size_t)-value2) : (size_t)value2)>::type::reduced_t tmp;
		return tmp;
	}
	template <bool has_sign2, size_t bits2, bits_to_int_t<bits2, has_sign2> value2>
	auto operator<<(const volatile fixed_integer_native_const<has_sign2, bits2, value2>&) const volatile
...
public:
	...
	static constexpr bool is_const_exponent_of_two = is_const_negative ? ((-(longest)int_value & ((longest)~(ulongest)-(longest)int_value + 1)) == -(longest)int_value) : ((int_value & (~int_value + 1)) == int_value);
...
private:
	...
	static constexpr size_t reduced_bits = is_const_zero ? 0 : (is_const_negative ? range_to_bits_v<(longest)value, 0> : range_to_bits_v<0, (ulongest)value>);
...
private:
	...
	template <size_t b, ulongest... args1>
	...
	template <ulongest nextLowDigit, ulongest... lowPart>
	class calculate_reduced
	{
	private:
...
#pragma warning(pop)
	...
	public:
		...
		public:
			...
			static constexpr bool new_overflow = overflow ? (new_low_digit <= low_digit) : (new_low_digit < low_digit);
			static constexpr bool is_negative2 = has_sign2 && ((longest)value2 < 0);
			static constexpr bool is_high_digit_negative = (is_const_negative == is_negative2) ? is_const_negative : (is_negative2 ? !!overflow : !overflow);

			static constexpr ulongest high_digit = is_high_digit_negative ? (ulongest)-1 : 0;
		public:
			typedef typename fixed_integer_extended_const<is_high_digit_negative, 8 * sizeof(ulongest) * (2 + sizeof...(lowPart)), lowPart..., new_low_digit, high_digit>::reduced_t type;
		};
	...
	{
	public:
		typedef typename lesser_t::as_extended_t::template get_modulo<typename modulo_t::as_extended_t>::type::as_extended_t modulo_t2;

		typedef typename get_gcd<lesser_t, modulo_t, modulo_t2>::type type;
	};

	template <typename greater_t, typename lesser_t>
	class get_gcd<greater_t, lesser_t, zero_t::as_extended_t>
	{
	public:
		typedef lesser_t type;
	};
	...
	template <typename greater_t>
	class get_gcd<greater_t, zero_t::as_extended_t, greater_t>
	{
	public:
		typedef greater_t type;
	};
	...
	public:
		...
		typedef typename fixed_integer_extended_const<has_sign, (sizeof(ulongest) * 8) + bits, 0, value>::
			template left_shift_extended<unused, remaining_shift_n>::type whole_shifted_t;
...
public:
	...
	constexpr size_t bit_scan_forward() const volatile
	{
		return fixed_integer_native_const<false, (sizeof(ulongest) * 8), value>::bit_scan_forward();
		//return const_bit_scan_forward;
	}

	constexpr size_t bit_scan_reverse() const volatile
	{
		return fixed_integer_native_const<false, (sizeof(ulongest) * 8), value>::bit_scan_reverse();
		//return const_bit_scan_reverse;
	}
...
{
public:
	static constexpr int value = const_compared_v<fixed_integer_extended_const<has_sign1, bits1, values1...>,
...
struct compatible<fixed_integer_extended_const<has_sign2, bits2, values2...>, int_t2, std::enable_if_t<is_integral_v<int_t2> > >
	: public compatible<fixed_integer_extended_const<has_sign2, bits2, values2...>, int_to_fixed_integer_t<int_t2> >
{
};

template <typename int_t2, bool has_sign2, size_t bits2, ulongest... values2>
struct compatible<int_t2, fixed_integer_extended_const<has_sign2, bits2, values2...>, std::enable_if_t<is_integral_v<int_t2> > >
