...
private:
	...
	static const uint8_t GA =		249;
	static const uint8_t EL =		248;
	static const uint8_t EC =		247;
	static const uint8_t AYT =		246;
	static const uint8_t AO =		245;
	static const uint8_t IP =		244;
	static const uint8_t BRK =		243;
	static const uint8_t DATAMARK =	242;
	static const uint8_t NOP =		241;
	static const uint8_t SE =		240;
	static const uint8_t SEND =		1;
	static const uint8_t IS =		0;

	static const uint8_t TELOPT_BINARY =		0;
	static const uint8_t TELOPT_ECHO =			1;
	static const uint8_t TELOPT_SGA =			3;	// Suppress Go Ahead. 
	static const uint8_t TELOPT_STATUS =		5;
	static const uint8_t TELOPT_TIMING =		6;
	static const uint8_t TELOPT_RCTE =			7;	
	static const uint8_t TELOPT_NAOCRD =		10;
	static const uint8_t TELOPT_NAOHTS =		11;
	static const uint8_t TELOPT_NAOHTD =		12;
	static const uint8_t TELOPT_NAOFFD =		13;
	static const uint8_t TELOPT_NAOVTS =		14;
	static const uint8_t TELOPT_NAOVTD =		15;
	static const uint8_t TELOPT_NAOLFD =		16;
	static const uint8_t TELOPT_EXTEND_ASCII =	17;	// WILL, DO
	static const uint8_t TELOPT_LOGOUT =		18;	// 
	static const uint8_t TELOPT_BM =			19;	// Byte Macro
	static const uint8_t TELOPT_DET =			20;	// Data Entry Terminal
	static const uint8_t TELOPT_SUPDUP =		21;	// SUPDUP terminal? RFC734
	static const uint8_t TELOPT_SUPDUPOUTPUT =	22;	// SUPDUP terminal within existing term? RFC749
	static const uint8_t TELOPT_SENDLOCATION =	23;	// Send location string
	static const uint8_t TELOPT_TTYPE =			24;	// Terminal Type - RFC1091
	static const uint8_t TELOPT_EOR =			25;	// Necessary?
	static const uint8_t TELOPT_TUID =			26;	// TAC?  - Anyone still use this?
	static const uint8_t TELOPT_OUTMRK =		27;	// RFC933
	static const uint8_t TELOPT_TTYLOC =		28;	// Terminal ID number
	static const uint8_t TELOPT_3270REGIME =	29;	// 3270 terminal?
	static const uint8_t TELOPT_X3PAD =			30;	// Support X.3-PAD
	static const uint8_t TELOPT_NAWS =			31;	// Negotiate about window size.
	static const uint8_t TELOPT_TERMSPEED =		32;	// Not meaningful anymore
	static const uint8_t TELOPT_FLOWCONTROL =	33;	// Not meaningful anymore
	static const uint8_t TELOPT_LINEMODE =		34;	// Line edit mode - Lots to do there
	static const uint8_t TELOPT_XDISPLOC =		35;	// X-Windows display addr
	static const uint8_t TELOPT_AUTHENTICATION =37;	// RFC2941
	static const uint8_t TELOPT_ENCRYPT =		38;	// RFC2946
	static const uint8_t TELOPT_NEWENVIRON =	39;	// Environment options
	static const uint8_t TELOPT_TN3270E =		40;	// TN3270 Enchancements	RFC2355
	static const uint8_t TELOPT_XAUTH =			41;	// XAUTH?
	static const uint8_t TELOPT_CHARSET =		42;	// RFC2066
	static const uint8_t TELOPT_RSP =			42;	// Remote Serial Port
	static const uint8_t TELOPT_COMPORTOPTION =	44;	// Not meaningful anymore
	static const uint8_t TELOPT_SLE =			45;	// Suppress Local Echo
	static const uint8_t TELOPT_STARTTLS =		46;	// Start TLS
	static const uint8_t TELOPT_KERMIT =		47;	// Kermit
	static const uint8_t TELOPT_SENDURL =		48;	// Send URL
	static const uint8_t TELOPT_FORWARDX =		49;	// Forward X?
	static const uint8_t TELOPT_EXOPL =			255;
