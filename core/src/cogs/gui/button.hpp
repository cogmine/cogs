...
#ifndef COGS_GUI_BUTTON
#define COGS_GUI_BUTTON
...
public:
	button(const action_delegate_t& action, const composite_string& text, const gfx::font& fnt = gfx::font(), bool isEnabled = true, bool isDefault = false)
		: m_action(action),
		m_text(text),
		m_font(fnt),
