...
private:
	...
	static const uint16_t BackBlack = 0;
	static const uint16_t ForeWhite = 0;
	static const uint16_t Red = 1;
	static const uint16_t Green = 2;
	static const uint16_t Cyan = 3;
	static const uint16_t Blue = 4;
	static const uint16_t Yellow = 5;
	static const uint16_t Magenta = 6;
	static const uint16_t BackWhite = 7;
	static const uint16_t ForeBlack = 7;
...
//		m_updateTable.append(false, screenChars);	// started empty
	...
	static const unsigned char BS = 0x08;
	static const unsigned char TAB = 0x09;
	static const unsigned char LF = 0x0A;
	static const unsigned char VT = 0x0B;
	static const unsigned char FF = 0x0C;
	static const unsigned char HOME = 0x0C;
	...
	//static const unsigned char MUSICNOTE	=	0x0E;
	static const unsigned char CSI = 0x9B;
	static const unsigned char DCS = 0x90;
	static const unsigned char ST = 0x9C;
	static const unsigned char SS3 = 0x8F;
	static const unsigned char IND = 0x84;
	static const unsigned char RI = 0x8D;
	static const unsigned char NEL = 0x85;
	static const unsigned char HTS = 0x88;
