...
protected:
	...
	endpoint(sockaddr* sockAddr, socklen_t sockAddrSize)
		: m_address(sockAddr, sockAddrSize)
	{ }

	endpoint(sockaddr_in* sockAddr, socklen_t sockAddrSize)
		: m_address(sockAddr, sockAddrSize)
	{ }

	endpoint(sockaddr_in6* sockAddr, socklen_t sockAddrSize)
		: m_address(sockAddr, sockAddrSize)
	{ }

	endpoint(sockaddr_storage* sockAddr, socklen_t sockAddrSize)
		: m_address(sockAddr, sockAddrSize)
	{ }
