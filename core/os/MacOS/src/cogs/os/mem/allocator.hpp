...
public:
	...
	static ptr<void> allocate(size_t n, size_t align)
	{
		void* p = 0;
	...
	static size_t get_allocation_size(const ptr<void>& p, size_t align, size_t knownSize)	{ return malloc_size(p.get_ptr()); }
};
